...
contract UniswapV2FactoryTest is Test {
    ...
    function testCreatePairWithErrorAsIdenticalTokens() public {
        vm.expectRevert(encodeError("IdenticalAddresses()"));
        factory.createPair(address(token0), address(token0));
    }
    function testCreatePairWithErrorAsZeroAddress() public {
    ...
    function testCreatePairWithErrorAsPairExists() public {
